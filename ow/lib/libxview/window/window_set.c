#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)window_set.c 20.147 93/04/07";
#endif
#endif
...
#ifdef OW_I18N
	    /* 
	     * Set XNCursor when WIN_CURSOR is set, for instance
	     * to support an overTheSpot preedit style.
	     */
...
#ifdef OW_I18N
		/*
		 * Set XNFontSet when XV_FONT is set, for
		 * instance to support an overTheSpot preedit style.
		 */
		if (win->win_use_im && win->xic) {
		   XVaNestedList       list;
