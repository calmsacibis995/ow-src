#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)txt_dbx.c 20.27 96/10/31";
#endif
#endif
    ...
    int             line;
{
    ...
    /*  ESC# 501318; BID# 1205013 - Fix removed due to bug 1236244 */
...
{
	/*
	 *  ESC# 501318; BID# 1205013
	 *  ESC# 504318; BID# 1236244
	 *  Use the appropriate textsw_index_for_file_line routine to get the
	 *  correct index for each string representation.
	 *   
	 *  This removes a fix to textsw_index_for_file_line for the same
	 *  problem.  This fix addresses the problem without alterring the
	 *  behavior of public routines.
	 */  
	if (multibyte)
