#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)notice.c 20.109 94/09/02";
#endif
#endif
...
#ifdef OW_I18N
    button->string = (CHAR *)_xv_mbstowcsdup(XV_MSG(notice_default_button_str));
#else
    button->string = xv_strsave(notice_default_button_str);
#endif
    button->is_yes = TRUE;
