#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)scrn_get.c 20.54 95/05/31";
#endif
#endif
    ...
    XVisualInfo *template;
{
	...
	if ((mask & VisualIDMask) || 
	    ...
	    ((mask & VisualClassMask) && (match->depth == default_depth)))
	  return(best_match);
		 ...
		 */
		if ((best_match->depth != default_depth) &&
    ...
    int		gc_index;
{
	...
	new_plane_mask != gc_values.plane_mask) {
