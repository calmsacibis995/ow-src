#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)font_x.c 20.33 93/12/06";
#endif
#endif
...
#define		FONT_TEMP_NAME_LEN	1024
    ...
    char                **fs_list;
{
    ...
    int			str_len = 0;
    char		temp_name_buf[FONT_TEMP_NAME_LEN];   
    ...
    font_name_list = temp_list = (str_len > FONT_TEMP_NAME_LEN) ?
