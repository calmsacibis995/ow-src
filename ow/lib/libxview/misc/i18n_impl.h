 ...
 * variables, however need to care the xgettext process (message
 * extraction).  While xgettext is processing, those XV_MSG should
 * have a constant instead.  Therefor, new macro XV_MSG_CONST for the
 * actual strings, and use XV_MSG_VAR for variable.  This method saves
 * 500 bytes in server_get_locale_from_str() function (in PIC object
 * code).
 */
#ifdef XGETTEXT
...
#define XV_MSG(s)		((s))
#define	XV_MSG_CONST(msg)	((s))
#define	XV_MSG_VAR(msg)		((s))
 ...
 * XView attributes.
 */
#define	FONT_COLUMN_WIDTH_I18N	FONT_COLUMN_WIDTH
 ...
 * XView attributes.
 */
#define	FONT_COLUMN_WIDTH_I18N	FONT_DEFAULT_CHAR_WIDTH
