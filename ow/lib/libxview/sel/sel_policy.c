#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)sel_policy.c 20.19 94/05/20";
#endif
#endif
 ...
 */
	...
	if (seln_request(holder, &buffer) == SELN_SUCCESS) {
	    if (*bufp++ != (u_int) SELN_REQ_BYTESIZE || *bufp == 0)
		return FALSE;
	    else {
		return TRUE;
	    }
