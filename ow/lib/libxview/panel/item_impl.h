...
#define IMAGE_STRING_I18N(image) ((image)->im_value.t.text_wc)
#else
#define IMAGE_STRING_I18N(image) ((image)->im_value.t.text)
#endif  /* OW_I18N */
...
#define IMAGE_SET_STRING_I18N(image, string) (image_string_wc(image) = (string))
#else
#define IMAGE_SET_STRING_I18N(image, string) (image_string(image)	= (string))
#endif /* OW_I18N */
...
#ifdef OW_I18N
   XFontSet		value_font_id; /* = panel->std_font_id by 
					       default */
#else
   XID			value_font_id; /* = panel->std_font_id by default */
#endif /* OW_I18N */
...
#endif /* OW_I18N */
#define PTEXT_IS_NUMTEXT 	  0x00000400 /* This is a numeric text item */
