#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)p_event.c 20.61 93/04/07";
#endif
#endif
...
#ifdef OW_I18N
	/* 
	 * We may need to resize the preedit region if it is being
	 * drawn by the input method.  For instance, update XNArea 
	 * if input method style is overTheSpot.
	 */
        if (panel->ic) {
            XRectangle	    x_rect;
