#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)svr_get.c 20.68 95/01/27";
#endif
#endif
    ...
    va_list         valist;
{
    ...
    switch (attr) {
      ...
      case SERVER_EXTERNAL_XEVENT_MASK: {
          ...
          Xv_opaque xid = va_arg(valist, Xv_opaque);
          Xv_opaque pkg_id = va_arg(valist, Xv_opaque);
          if (node = server_masknode_from_xidid (server, xid, pkg_id))
