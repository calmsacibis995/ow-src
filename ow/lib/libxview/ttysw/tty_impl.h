...
#define TTYSW_BUFLEN 8191
#define TTYSW_SCRATCHLEN 1024
#define TTYSW_SMALLBUF 48
...
struct cbuf {
    cbPtr          cb_rbp;    /* read pointer */
    cbPtr          cb_wbp;    /* write pointer */
    cbPtr          cb_ebp;    /* end of buffer */
    cbPtr          cb_buf;
};
