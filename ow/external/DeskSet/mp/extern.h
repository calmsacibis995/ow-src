...
extern char *prolog_locale ; /* Locale of prolog file */
extern int octal ;           /* Does "nextline" contain octal numbers */
...
extern int namefields ;      /* Maximum no. of "words" from passwd gecos. */
extern int namelength ;      /* Maximum no. of "chars" from passwd gecos. */
