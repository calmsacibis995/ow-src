#ifndef lint
static char sccsid[] = "@(#)mp.c 1.2 92/10/21 Copyr 1987 Sun Micro";
#endif
...
L40:
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_ADD2A]) ;
      FPRINTF(stderr, mpstrs[(int) MP_ADD2B]) ;
    }
 ...
 */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_PART1]) ;
...
L10:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_ASIN]) ;
...
/* THE FOLLOWING MESSAGE MAY INDICATE THAT B**(T-1) IS TOO SMALL. */
  ...
  if (v->MPerrors)
    FPRINTF(stderr, mpstrs[(int) MP_ATAN]) ;
...
/* CHECK LEGALITY OF B, T AND M */
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_CHKC]) ;
      FPRINTF(stderr, mpstrs[(int) MP_CHKD]) ;
    }
  mperr() ;
...
L40:
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_CHKE]) ;
      FPRINTF(stderr, mpstrs[(int) MP_CHKF]) ;
    }
  mperr() ;
...
L60:
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_CHKG]) ;
      FPRINTF(stderr, mpstrs[(int) MP_CHKH]) ;
    }
  mperr() ;
...
L80:
  ...
  if (v->MPerrors)
    FPRINTF(stderr, mpstrs[(int) MP_CHKI]) ;
...
/* HERE COMMON IS TOO SMALL, SO GIVE ERROR MESSAGE. */
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_CHKJ]) ;
      FPRINTF(stderr, mpstrs[(int) MP_CHKL]) ;
      FPRINTF(stderr, mpstrs[(int) MP_CHKM], *i, *j, mx) ;
      FPRINTF(stderr, mpstrs[(int) MP_CHKN], MP.mxr, MP.t) ;
    }
...
L30:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_CMD]) ;
...
L30:
  if (v->MPerrors)
    FPRINTF(stderr, mpstrs[(int) MP_CMR]) ;
...
L10:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_CQM]) ;
...
/* CHECK FOR DIVISION BY ZERO */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_DIVA]) ;
...
/* OVERFLOW HERE */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_DIVB]) ;
...
L10:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_DIVIA]) ;
...
L210:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_DIVIB]) ;
...
L50:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_EXPA]) ;
 ...
 */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_EXPB]) ;
...
L20:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_EXP1]) ;
...
/* CHECK THAT X IS POSITIVE */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_LNA]) ;
...
/* MAKE SURE NOT LOOPING INDEFINITELY */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_LNB]) ;
...
L10:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_LNSA]) ;
...
L60:
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_LNSB]) ;
      FPRINTF(stderr, mpstrs[(int) MP_LNSC]) ;
    }
...
L70:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_MULA]) ;
...
L90:
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_MULB]) ;
      FPRINTF(stderr, mpstrs[(int) MP_MULC]) ;
    }
...
/* CHECK FOR MULTIPLICATION BY B */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_MUL2A]) ;
...
L130:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_MUL2B]) ;
...
/* MULTIPLIES MP X BY I/J, GIVING MP Y */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_MULQ]) ;
...
L20:
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_NZRA]) ;
      FPRINTF(stderr, mpstrs[(int) MP_NZRB]) ;
    }
...
L150:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_NZRC]) ;
...
/* SET X TO LARGEST POSSIBLE POSITIVE NUMBER */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_OVFL]) ;
...
/* FOLLOWING MESSAGE MAY INDICATE THAT B**(T-1) IS TOO SMALL */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_PI]) ;
...
L20:
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_PWRA]) ;
      FPRINTF(stderr, mpstrs[(int) MP_PWRB]) ;
    }
...
L10:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_PWR2A]) ;
...
L30:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_PWR2B]) ;
...
/* MPADDI REQUIRES 2T+6 WORDS. */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_RECA]) ;
 ...
 */
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_RECB]) ;
      FPRINTF(stderr, mpstrs[(int) MP_RECC]) ;
    }
...
/* RESTORE M AND CHECK FOR OVERFLOW (UNDERFLOW IMPOSSIBLE) */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_RECD]) ;
...
L10:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_ROOTA]) ;
...
/* LOSS OF ACCURACY IF NP LARGE, SO ONLY ALLOW NP .LE. MAX (B, 64) */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_ROOTB]) ;
...
L70:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_ROOTC]) ;
...
L90:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_ROOTD]) ;
 ...
 */
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_ROOTE]) ;
      FPRINTF(stderr, mpstrs[(int) MP_ROOTF]) ;
    }
...
L40:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_SETB]) ;
...
/* SEE IF T TOO LARGE FOR DIMENSION STATEMENTS */
  ...
  if (v->MPerrors)
    {
      FPRINTF(stderr, mpstrs[(int) MP_SETC]) ;
      FPRINTF(stderr, mpstrs[(int) MP_SETD]) ;
      FPRINTF(stderr, mpstrs[(int) MP_SETE], i2) ;
    }
 ...
 */
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_SIN]) ;
...
L20:
  ...
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_SIN1]) ;
...
L10:
  if (v->MPerrors) FPRINTF(stderr, mpstrs[(int) MP_SQRT]) ;
