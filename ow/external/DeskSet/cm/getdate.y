%{
static  char sccsid[] = "@(#)getdate.y 3.8 97/06/10 Copyr 1988 Steven M. Bellovin";
%}
...
int mm, dd, yy, h, m, s, mer, zone, dayflag;
{
	...
	if (yy < 0) yy = -yy;
        if (yy < 38) yy += 2000;
        else if (yy > 69 && yy < 100 ) yy += 1900;
        if (yy < 1970 || yy > 2037 ) return (-1);
	mdays[1] = 28 + (yy%4 == 0);
#if 0
...
time_t cm_getdate(p, now) char *p; struct timeb *now;
{
