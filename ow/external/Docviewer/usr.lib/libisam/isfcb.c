#ifndef lint
        static char sccsid[] = "@(#)isfcb.c	1.3\t06/11/93 Copyr 1988 Sun Micro";
#endif
/*
...
void _remove_datfile(), _remove_indfile(), _remove_varfile();
    ...
    char	*isfname;
{
    ...
    return (open (namebuf, O_CREAT | O_EXCL | O_RDWR, 0666));
}
    ...
    Bool	rdonly;
{
    ...
    return (open (namebuf, (rdonly==TRUE)?O_RDONLY:O_RDWR));
}
