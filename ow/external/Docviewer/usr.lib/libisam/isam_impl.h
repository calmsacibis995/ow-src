...
#define MAXISFD		1024		     /* Max number of isfd : was 128*/
...
typedef struct fab {
    ...
    char		*localpath;	     /* ISAM file local pathname */
...
extern int _add1key(), _change1key(), _changekeys();
