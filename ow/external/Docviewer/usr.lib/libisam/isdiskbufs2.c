#ifndef lint
        static char sccsid[] = "@(#)isdiskbufs2.c	1.3\t06/11/93 Copyr 1988 Sun Micro";
#endif
...
/*---------------------- Local data ---------------------------------------*/
Bufhdr *_getavail(), *_findblock();
void _disk_init(), _commit1buffer(), _rollback1buffer(), _flush1buffer();
void _makenodata();
