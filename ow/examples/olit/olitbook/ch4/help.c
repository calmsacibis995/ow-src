...
static String HelpTitle = "OblongButton";
static String HelpMessage = 
      "Pressing this button activates the callback function";
...
main(unsigned int argc, char **argv)
{
  ...
  toplevel = XtAppInitialize(&app, "Help", NULL, 0, &argc, 
			     argv, NULL, NULL, 0);
  ...
  OlRegisterHelp(OL_WIDGET_HELP, (XtPointer)but1, HelpTitle, 
                 OL_STRING_SOURCE, (XtPointer)HelpMessage);
