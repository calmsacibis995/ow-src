#ifndef lint
#ifdef sccs
static char   sccsid[] = "@(#)get_selection.c 10.14 88/02/08";
#endif
#endif
...
static void		  quit(), seln_use_test_service();
    ...
    char                **argv;
{
	...
	switch (**argv) {
	  ...
	  case 'T':
	    ...
	    break;
	  default:
	    quit("Usage: xv_get_sel [D] [t seconds] [1 | 2 |3] [primary | secondary | clipboard]\n");
	}
    }
...
int                   secs;
{
    defaults_set_integer("selection.timeout",secs);
}
