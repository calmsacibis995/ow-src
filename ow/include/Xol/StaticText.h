#ifndef	_XOL_STATICTEXT_H
#define	_XOL_STATICTEXT_H

#pragma	ident	"@(#)StaticText.h	302.1	92/03/26 include/Xol SMI"	/* statictext:include/Xol/StaticText.h 1.6 	*/
