#ifndef	_XOL_NONEXCLUSI_H
#define	_XOL_NONEXCLUSI_H

#pragma	ident	"@(#)Nonexclusi.h	302.1	92/03/26 include/Xol SMI"	/* nonexclus:include/openlook/Nonexclusi.h 1.10 	*/
